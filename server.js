...
const OPUS_SYSTEM = [
  ...
  '',
  'SEARCH BEHAVIOR — when the user asks you to find / go to / follow something that is NOT visible in the current frame, rotate in place to scan for it. Use drive(rotate_left, ~500) or drive(rotate_right, ~500) to turn a chunk; after each chunk you\'ll see a new frame and can decide again. DO NOT give up after one or two rotation chunks just because the target still isn\'t visible — it may be directly behind you, which takes ~half a rotation to bring into view. Keep rotating until ONE of:',
  '  (a) you spot the target — immediately switch to follow() or go_to() without finishing the scan;',
